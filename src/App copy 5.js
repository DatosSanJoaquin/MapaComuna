...
function App() {
  ...
  const _AplicarFiltro = () => {
    const territorioSeleccionado = selectedFilters.territorio;
    const categoriasSeleccionadas = selectedFilters.categoria || [];
    ...
    if (territorioSeleccionado) {
      ...
      // 👇 Aquí se permite el flyTo
      setSelectedTerritory(territorioSeleccionado);
          ...
          <Row style={{ padding: "20px 14px 20px 14px" }}>
            <CampoDropDownSearchSimple
              ...
              OnChange={(e, i) => {
                ...
                setSelectedFilters((prev) => ({ ...prev, territorio: e }));
              }}
            />
            {/* <CampoDropDownSearchSimple
              PropiedadesCampo={{
            ...
            <CampoDropDownSearch
              ...
              OnChange={(e, i) => {
                ...
                setSelectedFilters((prev) => ({ ...prev, categoria: e }));
              }}
            />
          </Row>
